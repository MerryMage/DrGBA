...
template<typename T>
constexpr T ClearBit(size_t bit_position, const T value) {
    ASSERT_MSG(bit_position < BitSize<T>(), "bit_position must be smaller than size of T");
...
template<typename T>
constexpr T ModifyBit(size_t bit_position, const T value, bool new_bit) {
    ASSERT_MSG(bit_position < BitSize<T>(), "bit_position must be smaller than size of T");
...
/// Sign-extends a value that has bit_count bits to the full bitwidth of type T.
template<typename T>
constexpr T SignExtend(const size_t bit_count, const T value) {
...
constexpr size_t BitCount(Integral value) {
